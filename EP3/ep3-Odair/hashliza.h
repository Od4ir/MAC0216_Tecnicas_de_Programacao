...
/*!
 * @brief Gera uma nova string seguindo os procedimentos do Passo 1 do EP1. Esta função recebe um string no formato (char *) e devolve uma nova string seguindo os procedimentos do Passo 1 do EP1.
 *
 * @param stringEntrada Uma string (char *) de tamanho qualquer.
 * @return Uma nova string (char *) gerada a partir das transformações do Passo 1
 *         do EP1 de tamanho múltiplo de SIZE_BLOCO.
 */
